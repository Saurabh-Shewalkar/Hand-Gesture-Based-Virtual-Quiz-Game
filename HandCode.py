...
while True:
    ...
    if quesNumber < qTotal:
        ...
        frame, _ = cvz.putTextRect(frame, 'Total Questions: {}'.format(qTotal), [50, 50], 1, 2, colorT=(0, 0, 0),
                                   offset=10, border=4)
        frame, box = cvz.putTextRect(frame, mcq.question, [50, 150], 1, 2, cv.FONT_HERSHEY_SCRIPT_COMPLEX, offset=18,
                                     border=4)
        frame, box1 = cvz.putTextRect(frame, mcq.choice1, [50, 250], 1, 2, cv.FONT_HERSHEY_SIMPLEX, offset=15,
                                      border=4)
        frame, box2 = cvz.putTextRect(frame, mcq.choice2, [300, 250], 1, 2, cv.FONT_HERSHEY_SIMPLEX, offset=15,
                                      border=4)
        frame, box3 = cvz.putTextRect(frame, mcq.choice3, [50, 350], 1, 2, cv.FONT_HERSHEY_SIMPLEX, offset=15,
                                      border=4)
        frame, box4 = cvz.putTextRect(frame, mcq.choice4, [300, 350], 1, 2, cv.FONT_HERSHEY_SIMPLEX, offset=15,
                                      border=4)
        ...
        frame, _ = cvz.putTextRect(frame, 'Total No of Questions solved : {}'.format(qTotal), [150, 150], 1, 2,
                                   offset=15, border=3, colorB=(130, 200, 255), colorT=(255, 25, 25))
        frame, _ = cvz.putTextRect(frame, "Your Quiz Completed ", [150, 250], 1, 2, offset=15, border=3,
                                   colorB=(130, 200, 255), colorT=(255, 25, 25))
        frame, _ = cvz.putTextRect(frame, f'Your Score: {score}%', [150, 350], 1, 2, offset=15, border=3,
                                   colorB=(130, 200, 255), colorT=(255, 25, 25))
        frame, _ = cvz.putTextRect(frame, 'Press the Q/q button to Exit', [150, 450], 1, 2, offset=15, border=3,
                                   colorB=(130, 200, 255), colorT=(255, 25, 25))
